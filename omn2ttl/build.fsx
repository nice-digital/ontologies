...
let summary = "Manchester OWL Sytnax -> Turtle"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Converting Manchester OWL Syntax to Turtle via the OWL API, using F# and IKVM"

// List of author names (for NuGet package)
let authors = [ "Nathan Smith" ]

// Tags for your project (for NuGet package)
let tags = "fsharp manchester owl turtle rdf ontology ontologies"

// File system information 
let solutionFile  = "omn2ttl.sln"
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/NSmeef"
